...
`USER_TEST_PASSWORD`, and `USER_TEST_WRONG_PASSWORD`. The values of the first two properties are
...
export const LoginCredentials = {
  USER_TEST_EMAIL: Cypress.env('user_test_email'),
  USER_TEST_PASSWORD: Cypress.env('user_test_password'),
